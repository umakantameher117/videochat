const APP_ID = "20ba51ce6d844691954db58786b35903";
...
let handleLeftUser = async (user) => {
  delete remoteUsers[user.uid];
  document.getElementById(`user-container-${user.uid}`).remove();
};

let leaveAndCloseLocalTracks = async () => {
...
document
  ...
  .addEventListener("click", leaveAndCloseLocalTracks);
